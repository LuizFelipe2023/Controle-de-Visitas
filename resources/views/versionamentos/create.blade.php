    ...
    <div class="col-md-10">
        <div class="card shadow-lg border-0 rounded-4">
            <div class="card-header bg-dark rounded-top-4">
                <h4 class="mb-2 mt-2 fw-bold text-white text-center">Inserir Versionamento</h4>
            </div>

            <div class="card-body p-4">
                <form method="POST" action="{{ route('versionamentos.store') }}" id="versionamentoForm">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descricao" id="descricao" rows="4"
                                  ...
                                  placeholder="Descreva o versionamento" required>{{ old('descricao') }}</textarea>
                        @error('descricao')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
